package local.development.restfulharmony.api;
...
import local.development.restfulharmony.JsonTransformer;
...
public class HarmonyRest {
    ...
    private static final String HARMONY_REST_CONTEXT = "";
    ...
    public void setupServer() {
	    ...
	    Spark.get(HARMONY_REST_CONTEXT + "/list/activities", "application/json", (request, response) -> {
		...
		get(HARMONY_REST_CONTEXT + "/volumeUp", "application/json", (request, response) -> {
			String theArguments = "";
			theArguments = getVolumeForHegel(true);
		...
		get(HARMONY_REST_CONTEXT + "/volumeDown", "application/json", (request, response) -> {
			String theArguments = "";
			theArguments = getVolumeForHegel(false);
			String aResponse = sendDeviceCommand(theArguments, request, response);
	...
	private String getVolumeForHegel(boolean increaseVolume){
    	String theArguments;
    	if (increaseVolume){
			 theArguments = "{\n" +
					"\"device\" : \"Hegel Amp\",\n" +
